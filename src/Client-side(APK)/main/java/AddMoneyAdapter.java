...
//            holder.imgCardImage.setBackgroundDrawable( R.drawable.master_card );
        ...
        holder.btnAddMoney.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText( context, holder.CardHolerName.getText() + "", Toast.LENGTH_SHORT ).show();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            btnAddMoney = (Button) itemView.findViewById( R.id.btnAddMoney );
